...
// write code here
let course = "CIS101";
console.log(course); // CIS101
course = "CIS102";
console.log(course); // CIS102
...
// Reassignment fails because constants (`const`) cannot be changed after they are initialized.
...
console.log(2 + "3"); // "23"
console.log(2 + 3);   // 5
// The first two concatenate because when one operand is a string, JavaScript converts the other to a string and performs string concatenation instead of numeric addition.
...
let age = 20;  // Example input, replace with prompt() in browser
if (age < 13) {
    console.log("Child");
